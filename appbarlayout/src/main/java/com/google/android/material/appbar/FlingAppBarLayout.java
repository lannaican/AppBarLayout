...
@DefaultBehavior(FlingAppBarLayout.Behavior.class)
public class FlingAppBarLayout extends LinearLayout {
    ...
    private List<FlingAppBarLayout.BaseOnOffsetChangedListener> listeners;
    ...
    public FlingAppBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new androidx.core.view.OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                return FlingAppBarLayout.this.onWindowInsetChanged(insets);
            }
        });
    }

    public void addOnOffsetChangedListener(FlingAppBarLayout.BaseOnOffsetChangedListener listener) {
    ...
    public void addOnOffsetChangedListener(FlingAppBarLayout.OnOffsetChangedListener listener) {
        this.addOnOffsetChangedListener((FlingAppBarLayout.BaseOnOffsetChangedListener)listener);
    }

    public void removeOnOffsetChangedListener(FlingAppBarLayout.BaseOnOffsetChangedListener listener) {
    ...
    public void removeOnOffsetChangedListener(FlingAppBarLayout.OnOffsetChangedListener listener) {
        this.removeOnOffsetChangedListener((FlingAppBarLayout.BaseOnOffsetChangedListener)listener);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int z = this.getChildCount(); i < z; ++i) {
            ...
            FlingAppBarLayout.LayoutParams childLp = (FlingAppBarLayout.LayoutParams)child.getLayoutParams();
    ...
    private void updateCollapsible() {
        ...
        setLiftableState(haveCollapsibleChild);
    }
    ...
    private boolean hasCollapsibleChild() {
        ...
        for(int z = this.getChildCount(); i < z; ++i) {
            if (((FlingAppBarLayout.LayoutParams)this.getChildAt(i).getLayoutParams()).isCollapsible()) {
                return true;
            }
        }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return p instanceof FlingAppBarLayout.LayoutParams;
    }

    protected FlingAppBarLayout.LayoutParams generateDefaultLayoutParams() {
        return new FlingAppBarLayout.LayoutParams(-1, -2);
    }

    public FlingAppBarLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new FlingAppBarLayout.LayoutParams(this.getContext(), attrs);
    }

    protected FlingAppBarLayout.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (VERSION.SDK_INT >= 19 && p instanceof android.widget.LinearLayout.LayoutParams) {
            return new FlingAppBarLayout.LayoutParams((android.widget.LinearLayout.LayoutParams)p);
        } else {
            return p instanceof MarginLayoutParams ? new FlingAppBarLayout.LayoutParams((MarginLayoutParams)p) : new FlingAppBarLayout.LayoutParams(p);
        }
    }
    ...
    public final int getTotalScrollRange() {
        if (this.totalScrollRange != -1) {
            ...
            for(int z = this.getChildCount(); i < z; ++i) {
                View child = this.getChildAt(i);
                FlingAppBarLayout.LayoutParams lp = (FlingAppBarLayout.LayoutParams)child.getLayoutParams();
    ...
    void dispatchOffsetUpdates(int offset) {
        if (this.listeners != null) {
            ...
            for(int z = this.listeners.size(); i < z; ++i) {
                FlingAppBarLayout.BaseOnOffsetChangedListener listener = (FlingAppBarLayout.BaseOnOffsetChangedListener)this.listeners.get(i);
                if (listener != null) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
            return dependency instanceof FlingAppBarLayout;
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout parent, View child, Rect rectangle, boolean immediate) {
            FlingAppBarLayout header = this.findFirstDependency(parent.getDependencies(child));
            if (header != null) {
        ...
        private void offsetChildAsNeeded(View child, View dependency) {
            ...
            if (behavior instanceof FlingAppBarLayout.BaseBehavior) {
                FlingAppBarLayout.BaseBehavior ablBehavior = (FlingAppBarLayout.BaseBehavior)behavior;
        ...
        float getOverlapRatioForOffset(View header) {
            if (header instanceof FlingAppBarLayout) {
                FlingAppBarLayout abl = (FlingAppBarLayout)header;
        ...
        private static int getAppBarLayoutOffset(FlingAppBarLayout abl) {
            ...
            return behavior instanceof FlingAppBarLayout.BaseBehavior ? ((FlingAppBarLayout.BaseBehavior)behavior).getTopBottomOffsetForScrollingSibling() : 0;
        }

        FlingAppBarLayout findFirstDependency(List<View> views) {
            int i = 0;
        ...
        int getScrollRange(View v) {
            return v instanceof FlingAppBarLayout ? ((FlingAppBarLayout)v).getTotalScrollRange() : super.getScrollRange(v);
        }

        private void updateLiftedStateIfNeeded(View child, View dependency) {
            if (dependency instanceof FlingAppBarLayout) {
                FlingAppBarLayout appBarLayout = (FlingAppBarLayout)dependency;
    ...
    protected static class BaseBehavior<T extends FlingAppBarLayout> extends HeaderBehavior<T> {
        ...
        private FlingAppBarLayout.BaseBehavior.BaseDragCallback onDragCallback;
        ...
        public void setDragCallback(@Nullable FlingAppBarLayout.BaseBehavior.BaseDragCallback callback) {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T abl) {
            ...
            if (offsetChildIndex >= 0) {
                ...
                FlingAppBarLayout.LayoutParams lp = (FlingAppBarLayout.LayoutParams)offsetChild.getLayoutParams();
        ...
        private static View getAppBarChildOnOffset(FlingAppBarLayout layout, int offset) {
            int absOffset = Math.abs(offset);
            int i = 0;
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout parent, T abl) {
            ...
            for(int count = abl.getChildCount(); i < count; ++i) {
                ...
                if (child.getTop() + offset <= 0 && visBottom >= 0) {
                    FlingAppBarLayout.BaseBehavior.SavedState ss = new FlingAppBarLayout.BaseBehavior.SavedState(superState);
        ...
        public void onRestoreInstanceState(CoordinatorLayout parent, T appBarLayout, Parcelable state) {
            if (state instanceof FlingAppBarLayout.BaseBehavior.SavedState) {
                FlingAppBarLayout.BaseBehavior.SavedState ss = (FlingAppBarLayout.BaseBehavior.SavedState)state;
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            public static final Creator<FlingAppBarLayout.BaseBehavior.SavedState> CREATOR = new ClassLoaderCreator<FlingAppBarLayout.BaseBehavior.SavedState>() {
                public FlingAppBarLayout.BaseBehavior.SavedState createFromParcel(Parcel source, ClassLoader loader) {
                    return new FlingAppBarLayout.BaseBehavior.SavedState(source, loader);
                }

                public FlingAppBarLayout.BaseBehavior.SavedState createFromParcel(Parcel source) {
                    return new FlingAppBarLayout.BaseBehavior.SavedState(source, (ClassLoader)null);
                }

                public FlingAppBarLayout.BaseBehavior.SavedState[] newArray(int size) {
                    return new FlingAppBarLayout.BaseBehavior.SavedState[size];
                }
            };
        ...
        public abstract static class BaseDragCallback<T extends FlingAppBarLayout> {
    ...
    public static class Behavior extends FlingAppBarLayout.BaseBehavior<FlingAppBarLayout> {
        public Behavior() {
        }
        ...
        public abstract static class DragCallback extends FlingAppBarLayout.BaseBehavior.BaseDragCallback<FlingAppBarLayout> {
            public DragCallback() {
            }
        }
    }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        @RequiresApi(19)
        public LayoutParams(FlingAppBarLayout.LayoutParams source) {
            super(source);
    ...
    public interface OnOffsetChangedListener extends FlingAppBarLayout.BaseOnOffsetChangedListener<FlingAppBarLayout> {
        void onOffsetChanged(FlingAppBarLayout var1, int var2);
    }

    public interface BaseOnOffsetChangedListener<T extends FlingAppBarLayout> {
